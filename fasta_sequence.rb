...
###############################################################################
# This method extracts the organism common name.
def common_name
  parse_annotation if @annotation.keys.size < 1
  organism = @annotation[ "organism" ]
  index1 = organism.index( '(' )
  index2 = organism.index( ')' )
  if ( ! index1.nil? ) && ( ! index2.nil? )
    return organism.slice( (index1+1)...index2 )
  else
    return organism
  end  # if 
end  # common_name
...
###############################################################################
def header()
  return ">" + @sequence_name + " " + @sequence_description + "\n"
end  # method header
